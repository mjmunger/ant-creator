 ...
 * App Description: Allows users to time their work

 * App Version: 1.0
 * App Action: cli-load-grammar  -> loadTimer
       @ 90
 * App Action: cli-init          -> declareMySelf          @ 50
 * App Action: cli-command       -> processCommand         @ 50
 * App Action: load_loaders      -> Timer
AutoLoader @ 50
 *
 ...
 */
 ...
 /**
 * This app adds the Timer
 and commands into the CLI by adding in
...
class Timer
 extends AntApp  implements AppInterface  {
...
AutoLoader() {
        ...
        spl_autoload_register(array($this,'loadTimer
Classes'));
        return ['success' => true];
    }
...
Classes($class) {
 ...
 <michael@highpoweredhelp.com>
    ...
    function declareMySelf() {
        if($this->verbosity > 4 && $this->loaded ) print("Timer
 app loaded.\n");
